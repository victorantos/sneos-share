...
const INDEX_FILE = path.join(AUTOGENERATED_DIR, 'README.md');
...
const files = scanDirectory(AUTOGENERATED_DIR);
...
Object.keys(categorized).sort().forEach(category => {
  ...
  posts.forEach(post => {
    const link = `/autogenerated/${post.relativePath}.html`;
...
console.log(`✅ Generated README.md index with ${files.length} posts across ${Object.keys(categorized).length} categories`);